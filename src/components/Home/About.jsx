...
const AboutSection = () => {
  ...
  const testimonials = [
  {
    text: "Great service from Steve and Simon at Hussey Automotive in Crowthorne, Berkshire for replacing my clutch at short notice. Decent honest gentlemen and really know their stuff when it comes to Land Rovers! Thank you!",
    name: "Beavis Pits",
  },
